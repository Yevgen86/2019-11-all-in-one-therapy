...
<body>
<div class="flex-center position-ref full-height grey-layer">
    @if (Route::has('login'))
        <div class="top-right links">
            ...
            @else
                <a href="{{ route('login') }}" data-toggle="modal" data-target="#exampleModalCenter">Login</a>
            @endauth
        </div>
    @endif
...
<script>
    $(function () {
        $('input#search-patient').quicksearch('table tbody tr', {
